...
Customers can explore the menu, register, and place orders.

Admin can manage managers and oversee user activities.

Managers can handle menu items and view payment details.
