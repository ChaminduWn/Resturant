    ...
    <div className="flex items-center justify-center min-h-screen p-6 bg-gray-100">
      <div className="container max-w-screen-lg mx-auto">
        <div className="p-8 mb-6 bg-white rounded shadow-lg">
          <h2 className="mb-4 text-xl font-semibold text-gray-600">Food Adding Form</h2>
          <p className="mb-6 text-gray-500">Please fill out the form below to create a new food category.</p>
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 gap-4 text-sm gap-y-2 md:grid-cols-5">
              ...
              {imageUploadError && <p className="text-red-500 error md:col-span-5">{imageUploadError}</p>}
